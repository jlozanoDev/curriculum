    ...
    <div class="max-w-2xl mx-auto relative z-10">
      ...
      <div class="grid gap-3">
        <div
          ...
          :class="isDark
            ? 'bg-gray-800/60 border-gray-700 hover:border-purple-500/50 hover:shadow-purple-900/20'
        ...
        >
          ...
          <div
            ...
            :class="isDark ? 'bg-purple-900/50 text-purple-300' : 'bg-purple-50 text-purple-500'"
          >
