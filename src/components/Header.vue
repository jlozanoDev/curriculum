    ...
    <div class="relative z-10 text-center px-6 max-w-3xl">
      <div class="mb-8">
        ...
        >
          ...
          >
            <img src="/imagen.jpg" alt="Profile" class="w-full h-full object-cover scale-110" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <a
          v-if="profileData.contact.github"
          :href="profileData.contact.github"
          target="_blank"
          class="group flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg"
          :class="isDark
            ? 'bg-gray-900/60 text-green-300 border border-green-800 hover:bg-gray-800 hover:border-green-600 hover:shadow-green-900/30'
            : 'bg-gray-50 text-gray-700 border border-gray-200 hover:bg-gray-100 hover:border-gray-400 hover:shadow-gray-200/60'"
        >
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
